...
txt_path="/home/ucar/ucar_ws/src/object_detect/scripts/default_config.txt"
R_C_W = np.loadtxt(txt_path,delimiter=',')

print("R_C_W:", R_C_W)

#k1, k2, p1, p2, k3 = -0.318607, 0.097228, 0.000029, 0.000642, 0.
k1, k2, p1, p2, k3 = -0.322198, 0.102138, 0.002702, 0.000781, 0.
...
card_list = [b"corn", b"watermelon", b"cucumber", b"cornveg", b"riceveg", b"wheatveg", b"cucumberveg"]
...
def publish_image(imgdata):
    ...
    image_temp.is_bigendian = True#大端模式
...
def YOLO():
    ...
    # configPath = "/home/U-arm/xf_arm_ws/src/object_detect/scripts/config/yolov3-tiny.cfg"#yolov3-tiny权重文件
    # weightPath = "/home/U-arm/xf_arm_ws/src/object_detect/scripts/weights/yolov3-tiny_final.weights"
    # metaPath = "/home/U-arm/xf_arm_ws/src/object_detect/scripts/config/voc.data"#包括识别的种类，具体名称

    configPath = "/home/ucar/ucar_ws/src/yolo/yolov3-tiny.cfg"#yolov3-tiny权重文件
    weightPath = "/home/ucar/ucar_ws/src/yolo/yolov3-tiny_20000.weights"
    metaPath = "/home/ucar/ucar_ws/src/object_detect/scripts/config/voc.data"#包括识别的种类，具体名称
    ...
    while not rospy.is_shutdown():
        ...
        #gray_pub=cv2.cvtColor(frame_read, cv2.COLOR_BGR2GRAY)#转成灰度图
        publish_image(frame_rgb)
...
if __name__ == "__main__":
    try:
        ...
        image_pubulish = rospy.Publisher('/arm/image_raw', Image, queue_size=1)
