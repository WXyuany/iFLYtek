...
def bounding_boxes_callback(msg):
    ...
    for box in msg.bounding_boxes:
        ...
        if box.Class == target_class:
            ...
            # 根据控制输出决定小车的转向
            # if control_output > 0:
            if control_output > 0.4997:
                twist_msg.angular.z = turn_speed  # 左转
            # elif control_output < 0:
            elif control_output < 0.4995:
                twist_msg.angular.z = -turn_speed  # 右转
            # else:
            else:
                twist_msg.angular.z = 0.0  # 直走
